...
if(isset($_POST["query"]))
{
    ...
    $query = "SELECT  w.QuestionID,w.CreateDate,w.Question,w.Details,w.View,w.Reply,w.Category,u.image,w.Major
                FROM webboard w 
                INNER JOIN user u
                ON w.Name = u.username 
                WHERE w.Major = 'Social' AND  Question LIKE '%".$search."%' ";
}
else
{
    $query = " SELECT  w.QuestionID,w.CreateDate,w.Question,w.Details,w.View,w.Reply,w.Category,u.image,w.Major
                FROM webboard w 
                INNER JOIN user u
                ON w.Name = u.username WHERE w.Major = 'Social' ORDER BY QuestionID ";
}
